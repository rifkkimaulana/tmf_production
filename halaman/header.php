                ...
                <div class="col-sm-12">
                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <a href="<?php echo $base_url; ?>/" class="navbar-brand">
                            <img src="<?php echo $base_url; ?>/images/logo.png" class="img-fluid logo" alt="" />
                        </a>
                                    ...
                                    <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                                                    ...
                                                    <div class="iq-card-body">
                                                        <a href="#" class="iq-sub-card">
                                                            <div class="media align-items-center">
                                                                <img src="<?php echo $base_url; ?>/images/notify/thumb-1.jpg"
                                                        ...
                                                        <a href="#" class="iq-sub-card">
                                                            <div class="media align-items-center">
                                                                <img src="<?php echo $base_url; ?>/images/notify/thumb-2.jpg"
                                                                    alt="" class="img-fluid mr-3" />
                                                                <div class="media-body">
                                                                    <h6 class="mb-0">
                                                        ...
                                                        <a href="#" class="iq-sub-card">
                                                            <div class="media align-items-center">
                                                                <img src="<?php echo $base_url; ?>/images/notify/thumb-3.jpg"
                                                                    alt="" class="img-fluid mr-3" />
                                                                <div class="media-body">
                                        ...
                                        <li>
                                            <a href="#"
                                                ...
                                                <img src="<?php echo $base_url; ?>/images/user/user.png"
