<div class="card-body">
    ...
    <div class="tab-content">
        <div class="tab-pane fade show" id="pengaturan_film">
            </br>
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="judul" name="judul"
                    value="<?php echo $row_tmdb['judul']; ?>" disabled>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="bahasa" name="bahasa"
                    value="<?php echo $row_tmdb['bahasa']; ?>" disabled>
                <small class="text-muted">Isi dengan bahasa lisan tv show dari TMDB.</small>
            </div>
            <div class="form-group">
                <label for="tagline">Tagline (TMDB):</label>
                <input type="text" class="form-control" id="tagline" name="tagline" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="rating_mpaa" name="rating_mpaa" disabled
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="tanggal_rilis" name="tanggal_rilis" disabled
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="tahun_rilis" name="tahun_rilis" placeholder="yyyy"
                        disabled value="<?php echo $row_tmdb['tahun_rilis']; ?>">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="tanggal_terakhir_mengudara" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="waktu_jalan" name="waktu_jalan" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah_episode" name="jumlah_episode" disabled
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="rating_tmdb" name="rating_tmdb" disabled
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="other_input" name="other_input" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="anggaran" name="anggaran" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pendapatan" name="pendapatan" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="youtube_id" name="youtube_id" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="penerjemah" name="penerjemah" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="url_poster" name="url_poster" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="imdb_id" name="imdb_id" disabled
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tmdb_id" name="tmdb_id" disabled
                    value="<?php echo $row_tmdb['tmdb_id']; ?>">
                <small class="text-muted">Isi dengan ID tv show dari TMDB. Contoh: 244786.</small>
            </div>
        </div>

        <div class="tab-pane fade active" id="pengaturan_player">
            <div class="form-group">
                </br>
