    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="pengaturan_film">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="tanggal_rilis" name="tanggal_rilis"
                        placeholder="dd mmm yyyy" value="<?php echo $tanggal_rilis; ?>">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="other_input" name="other_input" value="10">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="imdb_id" name="imdb_id" value="<?php echo $id_imdb; ?>">
                <small class="text-muted">Isi dengan ID tv show dari IMDb. Contoh:
                    tt2582802.</small>
            </div>
            <div class="form-group">
                <label for="tmdb_id">tmdbID:</label>
                <input type="text" class="form-control" id="tmdb_id" name="tmdb_id" value="<?php echo $id_tmdb; ?>">
