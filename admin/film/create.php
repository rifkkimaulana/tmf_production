                ...
                <div class="col-4">
                    ...
                    <div id="accordion">
                        ...
                        <script>
                           ...
                           // Fungsi untuk memperbarui nilai pada elemen input hidden
                            function updateSelectedGenres() {
                                // Ambil semua elemen checkbox yang ada dalam form
                                var checkboxes = document.querySelectorAll('#genreContainer input[type="checkbox"]:checked');

                                // Buat array untuk menyimpan nilai-nilai checkbox yang dipilih
                                var selectedGenresArray = [];

                                // Loop melalui checkbox yang dipilih dan tambahkan nilainya ke dalam array
                                for (var i = 0; i < checkboxes.length; i++) {
                                    selectedGenresArray.push(checkboxes[i].value);
                                }

                                // Ubah array menjadi string dengan nilai-nilai dipisahkan oleh tanda koma
                                var selectedGenresString = selectedGenresArray.join(',');

                                // Set nilai input hidden dengan string nilai checkbox yang dipilih
                            ...
                            // Panggil fungsi updateSelectedGenres() untuk menginisialisasi nilai awal saat halaman dimuat
                                    ...
                                    <script>
                                        function addTag() {
                                            ...
                                            if (tags.length > 0 && tags[0] !== "") {
                                                const tagContainerElement = document.getElementById("tagList");t
